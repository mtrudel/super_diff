      ...
      as_both_colored_and_uncolored do |color_enabled|
        ...
        expected_output = build_expected_output(
          ...
          expectation: proc {
            line do
              plain "Expected "
              beta %|2011-12-13 16:15:16.000 CET +01:00 (ActiveSupport::TimeWithZone)|
            end
          ...
          diff: proc {
            ...
            alpha_line "-   zone: \"UTC\","
            beta_line  "+   zone: \"CET\","
            alpha_line "-   gmt_offset: 0,"
            beta_line  "+   gmt_offset: 3600,"
            alpha_line "-   utc: 2011-12-13 14:15:16.000 UTC +00:00 (Time)"
            beta_line  "+   utc: 2011-12-13 15:15:16.000 UTC +00:00 (Time)"
            plain_line "  }>"
          },
        )
